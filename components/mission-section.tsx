        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`space-y-6 ${isVisible ? "animate-fade-in-up animation-delay-200" : "opacity-0"}`}>
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-card rounded-full border border-border">
              ...
              <span className="text-xs font-medium text-muted-foreground">Social Impact Initiative</span>
            </div>
            ...
            <p className="text-muted-foreground leading-relaxed">
              At AERONYX, we believe in the power of education to transform lives. That's why 55% of our profits go
              directly to supporting girl-child education initiatives across underserved communities.
            </p>

            <p className="text-muted-foreground leading-relaxed">
              When you wear AERONYX, you're not just investing in your performance — you're investing in a brighter
              future for girls who deserve the chance to learn, grow, and lead.
            </p>
